...
#include "src/Qt/UIs/StartScreen.h"
...
static const char qt_meta_stringdata_StartScreen[] = {
    "StartScreen\0"
};

const QMetaObject StartScreen::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StartScreen,
      qt_meta_data_StartScreen, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StartScreen))
